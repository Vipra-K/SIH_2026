...
app.include_router(stream_router);app.include_router(video_router);app.include_router(camera_source_router);app.include_router(zones_router);app.include_router(processed_video_router)
...
@app.get("/api/health")
def health(): return {"status":"ok","service":"bordersight-api","version":"0.4.0"}
